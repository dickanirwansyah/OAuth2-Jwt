...
public class ConfigurationOAuth2 extends AuthorizationServerConfigurerAdapter{
    ...
    private String clientId = "clientGojekApp";
    private String clientSecret = "mysecret";

    //------NOTE PENTING------------\\
    //OAuth2.0 integrasi dengan
    //JWT TOKEN HARUS ADA SIGNATURE KEY
    //YAITU private key dan public key
    //dengan di generate open-ssl dan
    //Algoritma RSA.
    //Karena jika tidak ada private key
    //Maupun Public Key,
    //Maka Signature key atau token tidak akan sah
    //atau tidak valid
    //-----@DickaNirwansyah-----\\
